...
public abstract class BaseCtl extends HttpServlet {
	 ...
	 * are given to Read : Guest, Patient, Doctor, Admin Add : Patient, Doctor,
	 * Admin Write : Patient, Doctor, Admin Delete : Admin
	 */
	protected void setAccess(HttpServletRequest request) {

		AccessUtility.setReadAccess(AppRole.GUEST + "" + AppRole.PATIENT + ""
				+ AppRole.DOCTOR + "" + AppRole.ADMIN, request);

		AccessUtility.setWriteAccess(AppRole.GUEST + "" + AppRole.DOCTOR + ""
				+ AppRole.ADMIN, request);

		AccessUtility.setAddAccess(AppRole.GUEST + "" + AppRole.DOCTOR + ""
				+ AppRole.ADMIN, request);

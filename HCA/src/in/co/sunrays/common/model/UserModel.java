...
import in.co.sunrays.hca.exception.RecordNotFoundException;
...
public class UserModel extends BaseModel {
	...
	public boolean changePassword(Long id, String oldPassword,
		...
		msg.setSubject("Health Care Adviser HCA Password has been changed Successfully.");
	...
	public long registerUser() throws ApplicationException,
		...
		msg.setTo(login);
		msg.setSubject("Registration is successful for HCA Project");
		msg.setMessage(message);
		msg.setMessageType(EmailMessage.HTML_MSG);
	...
	public boolean forgetPassword(String login) throws ApplicationException,
		...
		EmailMessage msg = new EmailMessage();
		msg.setTo(login);
		msg.setSubject("HCA Password reset");
		msg.setMessage(message);
		msg.setMessageType(EmailMessage.HTML_MSG);
		EmailUtility.sendMail(msg);
		flag = true;
